# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 19:21:06 2024
...
class EarlyStopping:
    ...
    def save_checkpoint(self, score, model):
        ...
        torch.save(model.state_dict(), os.path.join(model_path, 'All_domain_classifier.pkl'))
...
train_ds = AllDomainData(32, 32, is_training=True)
test_ds = AllDomainData(32, 32, is_training=False)
...
current_setting = f'All_domain_batch{BATCH_SIZE}'
